...
class DDPG(object):
    ...
    def load(self):
        ...
        self.actor.load_state_dict(
            torch.load("/home/liujian/桌面/single_arm_3dof_torch/DDPG（预训练）/pre_train/pretrain_actor.pth"))
        self.actor_target.load_state_dict(
            torch.load("/home/liujian/桌面/single_arm_3dof_torch/DDPG（预训练）/pre_train/pretrain_actor.pth"))
        # self.actor.load_state_dict(
        #     torch.load(directory + "/" + "149_actor.pth"))
        # self.critic.load_state_dict(
        #     torch.load(directory + "/" + "149_critic.pth"))
