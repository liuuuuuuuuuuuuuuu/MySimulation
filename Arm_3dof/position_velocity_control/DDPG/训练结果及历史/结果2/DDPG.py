...
env_name = "Arm-v1"
algorithm_name = "DDPG"
directory = current_file + '/train_log/' + env_name + '/' + algorithm_name + '/' + date
...
class DDPG(object):
    ...
    def choose_action_train(self, s):
        ...
        action_noise = torch.FloatTensor(np.random.normal(0, scale=self.explore_noise, size=3))
    ...
    def load(self):
        ...
        #     torch.load("/home/liujian/桌面/single_arm_3dof_torch/DDPG（复件）/pre_train/pretrain_actor.pth"))
        # self.actor_target.load_state_dict(
        #     torch.load("/home/liujian/桌面/single_arm_3dof_torch/DDPG（复件）/pre_train/pretrain_actor.pth"))
        self.actor.load_state_dict(
            torch.load(directory + "/" + "449_actor.pth"))
        self.critic.load_state_dict(
            torch.load(directory + "/" + "449_critic.pth"))
        # self.critic.load_state_dict(
        #     torch.load(directory + "/" + "199_critic.pth"))
        print("====================================")
